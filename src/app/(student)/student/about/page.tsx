...
export default function AboutPage() {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-black/40 px-6 pb-6 pt-12">
        {/* Header */}
        <div className="mb-6 flex items-center justify-center">
          <h1 className="text-2xl font-bold tracking-widest text-white">Tungkol sa App</h1>
        </div>

        {/* Content Container */}
        <div className="mb-4 flex-1 overflow-hidden rounded-3xl border-4 border-[#8B4513] bg-[#efede6] shadow-2xl">
          <div className="items-center bg-[#8B4513] py-3">
            <h2 className="font-bold text-lg italic text-[#E8D4B0]">P4 MODEL</h2>
          </div>
          ...
          <div className="flex-1 p-6 overflow-y-auto">
            ...
            <p className="mb-3 font-bold text-base text-[#3e2723]">Mga Mananaliksik</p>

            <div className="mb-8 space-y-2">
              <p className="text-sm text-[#3e2723]">- Diaz, Althea Ashley O.</p>
              <p className="text-sm text-[#3e2723]">- Dombrique, Ashley Nicole D.</p>
            ...
            <p className="mb-10 text-sm text-[#3e2723]">v1.0.0 (Alpha)</p>
          </div>
        </div>
