...
export default function Pagsisiyasat4to6({ rangeId }: { rangeId: string }) {
  ...
  return (
    <div className="pb-4">
      ...
      {/* ===== CASE 1 ===== */}
      <div className="mb-6">
        <h3 className="font-serif text-2xl font-bold text-[#3e2723] mb-1">
          Case 1: Sino ang Suspek?
        </h3>
        <p className="text-xs text-[#5d4037] mb-3 leading-relaxed">
          <span className="font-bold">Panuto:</span> Batay sa nabasang akda,
          isulat ang pangalan ng tatlong (3) tauhan na posibleng suspek o may
          motibo sa pagkakakulong sa ama ni Crisostomo Ibarra.
        </p>
          ...
          {[1, 2, 3].map((i) => (
            <div key={i} className="flex flex-col items-center gap-2">
              ...
              <div className="relative w-full aspect-square rounded-lg border-2 border-[#3e2723] bg-white overflow-hidden flex items-end justify-center">
                <svg
                  viewBox="0 0 60 60"
                  className="w-3/4 text-[#3e2723]"
                  fill="currentColor"
                >
                  <circle cx="30" cy="20" r="12" />
                  <path d="M10 55 Q10 38 30 38 Q50 38 50 55" />
                </svg>
                <span className="absolute top-1 left-1/2 -translate-x-1/2 font-serif text-3xl font-bold text-black drop-shadow">
                  ?
                </span>
              </div>
              {/* Input */}
      ...
      <div className="mb-6">
        ...
        <p className="text-xs text-[#5d4037] mb-3 leading-relaxed">
          <span className="font-bold">Panuto:</span> Mula sa mga suspek na iyong
          inilagay sa Case 1, ilahad mo ang motibo kung bakit sila ang iyong
          pinaghihinalaang nagpakulong sa ama ni Crisostomo Ibarra.
        </p>
        <div className="rounded-xl overflow-hidden border-2 border-[#3e2723]">
          {/* Table header */}
          <div className="grid grid-cols-2 bg-[#3e2723]">
            <div className="p-2 text-center text-xs font-bold text-[#e8d4b0] border-r border-[#8d6e63]">
              Motibo
            </div>
            <div className="p-2 text-center text-xs font-bold text-[#e8d4b0]">
              Paliwanag
            </div>
          </div>
          {[1, 2, 3].map((row, idx) => (
            <div
              key={row}
              className={`grid grid-cols-2 ${idx < 2 ? "border-b border-[#c4b09a]" : ""} ${idx % 2 === 0 ? "bg-[#efede6]" : "bg-[#f5ede0]"}`}
            >
      ...
      <div className="mb-4">
        <div className="flex items-center gap-2 mb-1">
          <svg
            className="w-10 h-10 text-[#3e2723]"
            fill="currentColor"
            viewBox="0 0 20 20"
          >
            <path
        ...
        <p className="text-xs text-[#5d4037] mb-3 leading-relaxed">
          <span className="font-bold">Panuto:</span> Sagutin ang tanong sa
          ibaba. Ipaliwanag at ilahad batay sa iyong pagkakaunawa sa nobela.
        </p>
        <div className="rounded-xl border-2 border-[#3e2723] bg-white p-4">
          <p className="text-xs font-bold text-[#3e2723] mb-3 leading-relaxed">
            Batay sa iyong pagsusuri sa nobela, sino ang tunay na salarin sa
            pagkakakulong ng ama ni Crisostomo Ibarra, at paano niya
            naisakatuparan ang kaniyang masamang layunin?
          </p>
          <textarea
